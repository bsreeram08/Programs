...
public class Main2Activity extends AppCompatActivity {
    ...
    public void findneighbours(int r,int c)
    {
        ...
        for (int i = 0; i < 9; i++)
        {
            ...
            if ((r >= 0 && r < val) && (c >= 0 && c < val))
            {
                ...
                if (b1.getTag().toString().equals("0"))
                {
                    b1.setTag("1");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<val;i++)
        {
            for( int j=0;j<val;j++)
            {
                ...
                if(val==8) {
                    ...
                    gridLayout.addView(button, 155, 155);
                    flag=random=6;
                }
                else if(val==4)
                {
        ...
        final Button b1 = (Button) findViewById(R.id.continueButton);
